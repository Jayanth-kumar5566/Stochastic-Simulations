...
def st_sim(beta1,beta2,lam,mu,N1,N2,gamma,sigma,tr12,tr21,alpha):
    # Intial values:
    ...
    while count < MAX and t < tmax and (I1+I2)<(N1+N2)*0.4:
        ...
        K  = Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_S12I1+Rate_S22I2#+Rate_I12I2+Rate_I22I1
        ...
        if r < Rate_S12E1:
            ...
            S2 -= 1
        elif r < Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_S12I1:
            S1 -= 1
            I1 += 1
        elif r < Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_S12I1+Rate_S22I2:
            S2 -= 1
            I2 += 1
        '''
        elif r < Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_I22I1+Rate_S12I1+Rate_S22I2:
            I2 -= 1
            I1 += 1
        elif r < Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_I22I1+Rate_I12I2+Rate_S12I1+Rate_S22I2:
            I1 -= 1
            I2 += 1
        '''
...
def Rcode(time,series):
    ...
    os.system('rm y.csv')
    os.system('rm tmp')
    return (float(co),float(sl),float(rsq))
