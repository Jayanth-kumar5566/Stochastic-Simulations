...
def st_sim(beta1,beta2,N1,N2,gamma,sigma,tr12,tr21):
    # Intial values:
    tmax = 1000  #Default value can be changed if needed
    ...
    while count < MAX and t < tmax and I1>0 and I2>0:
        Rate_S12E1 = beta1*S1*I1
        Rate_E12I1 = sigma*E1
        Rate_I12R1 = gamma*I1 
        Rate_S22E2 = beta2*S2*I2
        Rate_E22I2 = sigma*E2
        Rate_I22R2 = gamma*I2
        Rate_S22S1 = tr21*S2
        Rate_E22E1 = tr21*E2
        ...
        K  = Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2
