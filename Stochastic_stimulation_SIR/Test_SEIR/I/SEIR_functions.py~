...
def st_sim(beta1,beta2,lam,mu,N1,N2,gamma,sigma,tr12,tr21):
    ...
    while count < MAX and t < tmax and I1>0 and I2>0:
        ...
        K  = Rate_S12E1+Rate_E12I1+Rate_I12R1+Rate_S22E2+Rate_E22I2+Rate_I22R2+Rate_S22S1+Rate_E22E1+Rate_R22R1+Rate_S12S2+Rate_E12E2+Rate_R12R2+Birth_S1+Birth_S2+Death_E1+Death_I1+Death_R1+Death_E2+Death_I2+Death_R2+Death_S1+Death_S2+Rate_I22I1+Rate_I12I2
