...
plt.text(0.7,14.7,'$R_{0}$ of settlement2',fontsize=15)
plt.text(0.7,7.7,'$R_{0}$ of settlement1',fontsize=15)
plt.text(0.7,11.2,'Average of $R_{0}$ of settlements',fontsize=15)
